...
import 'package:studyking/core/data/repositories/badge_repository.dart';
  ...
  group('BadgeRepository', () {
    ...
    group('save', () {
      ...
      test('overwrites existing badge with same id', () async {
        await repository.save(createTestBadge(name: 'Original'));
        await repository.save(createTestBadge(name: 'Updated'));
    ...
    group('get', () {
      ...
      test('returns stored badge', () async {
        await repository.save(createTestBadge());
    ...
    group('hasBadge', () {
      test('returns true when student has the badge', () async {
        await repository.save(createTestBadge(id: 'b1', studentId: 's1'));
    ...
    group('getBadgeMap', () {
      test('returns map of badge id to badge for student', () async {
        await repository.save(createTestBadge(id: 'b1', studentId: 's1', name: 'First'));
        await repository.save(createTestBadge(id: 'b2', studentId: 's1', name: 'Second'));
        await repository.save(createTestBadge(id: 'b3', studentId: 's2'));
    ...
    group('getBadgeCount', () {
      test('returns correct count for student', () async {
        await repository.save(createTestBadge(id: 'b1', studentId: 's1'));
        await repository.save(createTestBadge(id: 'b2', studentId: 's1'));
        await repository.save(createTestBadge(id: 'b3', studentId: 's2'));
    ...
    group('getAll', () {
      test('returns all badges', () async {
        await repository.save(createTestBadge(id: 'b1'));
        await repository.save(createTestBadge(id: 'b2'));
