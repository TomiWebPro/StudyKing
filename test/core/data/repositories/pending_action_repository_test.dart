  ...
  group('PendingActionRepository', () {
    ...
    group('save', () {
      ...
      test('overwrites existing action with same id', () async {
        await repository.save(createTestAction(actionType: 'schedule'));
        await repository.save(createTestAction(actionType: 'reschedule'));
    ...
    group('get', () {
      ...
      test('returns stored action', () async {
        await repository.save(createTestAction());
    ...
    group('markCompleted', () {
      test('marks pending action as completed', () async {
        await repository.save(createTestAction(id: 'a1', studentId: 's1'));
    ...
    group('delete', () {
      test('removes an action', () async {
        await repository.save(createTestAction(id: 'a1'));
    ...
    group('clearAll', () {
      test('removes all actions for a student', () async {
        await repository.save(createTestAction(id: 'a1', studentId: 's1'));
        await repository.save(createTestAction(id: 'a2', studentId: 's1'));
        await repository.save(createTestAction(id: 'a3', studentId: 's2'));
