  ...
  group('PlanAdherenceRepository', () {
    ...
    group('save', () {
      ...
      test('overwrites existing record with same id', () async {
        await repository.save(createTestAdherence(adherenceScore: 0.5));
        await repository.save(createTestAdherence(adherenceScore: 0.9));
    ...
    group('get', () {
      ...
      test('returns stored record', () async {
        await repository.save(createTestAdherence());
    ...
    group('delete', () {
      test('removes a record', () async {
        await repository.save(createTestAdherence(id: 'a1'));
    ...
    group('deleteByStudent', () {
      test('removes all records for a student', () async {
        await repository.save(createTestAdherence(id: 'a1', studentId: 's1'));
        await repository.save(createTestAdherence(id: 'a2', studentId: 's1'));
        await repository.save(createTestAdherence(id: 'a3', studentId: 's2'));
