...
void main() {
  group('Markscheme', () {
    ...
    group('toJson', () {
      test('serializes all fields', () {
        ...
        expect(json['markschemePoints'], 2.0);
    ...
    group('serialization roundtrip', () {
      test('preserves all fields', () {
        final step = MarkSchemeStep(stepNumber: '1', requiredAnswer: 'A', points: 1.0);
  ...
  group('MarkSchemeStep', () {
    group('constructor', () {
      test('creates with required fields', () {
        final step = MarkSchemeStep(stepNumber: '1', requiredAnswer: 'F=ma', points: 2.0);
    ...
    group('fromJson', () {
      test('deserializes all fields', () {
        final json = {'stepNumber': '1', 'requiredAnswer': 'A', 'points': 2.0};
      ...
      test('handles missing points', () {
        final json = {'stepNumber': '1', 'requiredAnswer': 'A'};
        final step = MarkSchemeStep.fromJson(json);
    ...
    group('serialization roundtrip', () {
      test('preserves all fields', () {
        final original = MarkSchemeStep(stepNumber: '1', requiredAnswer: 'A', points: 3.0);
