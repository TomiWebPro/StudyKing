...
import 'package:studyking/features/planner/presentation/widgets/pending_actions_section.dart';
...
void main() {
  group('PendingActionsSection', () {
    testWidgets('returns SizedBox.shrink when no pending actions', (tester) async {
      await tester.pumpWidget(buildApp(const PendingActionsSection()));
