...
import 'package:studyking/features/planner/presentation/widgets/missed_lessons_section.dart';
...
void main() {
  group('MissedLessonsSection', () {
    testWidgets('shows all caught up when no missed lessons', (tester) async {
      await tester.pumpWidget(buildApp(const MissedLessonsSection()));
