...
import 'package:studyking/features/planner/presentation/widgets/scheduled_lessons_section.dart';
...
void main() {
  group('ScheduledLessonsSection', () {
    testWidgets('returns SizedBox.shrink when no scheduled lessons', (tester) async {
      await tester.pumpWidget(buildApp(const ScheduledLessonsSection()));
