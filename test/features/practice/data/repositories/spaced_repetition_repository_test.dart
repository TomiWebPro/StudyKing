...
void main() {
  ...
  group('SpacedRepetitionService (init with real Hive)', () {
    ...
    setUp(() async {
      ...
      final dir = await Directory.systemTemp.createTemp('sr_service_test_');
      hivePath = dir.path;
      Hive.init(hivePath);
    ...
    test('init and getQuestionsDue returns success', () async {
      final result = await service.getQuestionsDue();
      expect(result.isSuccess, isTrue);
    });
