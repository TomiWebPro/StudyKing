    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          _buildInfoRow(context, 'Last Attempted',
          ...
          if (state.recentAccuracy.length >= 2) ...[
            ...
            Text('Accuracy Trend', style: theme.textTheme.titleSmall),
