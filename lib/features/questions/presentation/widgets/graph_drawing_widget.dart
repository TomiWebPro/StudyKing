...
class GraphDrawingWidget extends StatefulWidget {
  ...
  @override
  State<GraphDrawingWidget> createState() => _GraphDrawingWidgetState();
}

class _GraphDrawingWidgetState extends State<GraphDrawingWidget> {
  static final Logger _logger = const Logger('GraphDrawingWidget');
  ...
  Widget build(BuildContext context) {
    ...
    final totalPoints = _strokes.fold<int>(0, (sum, s) => sum + s.points.length);
    return Column(
      ...
      children: [
        ...
        Semantics(
          container: true,
          label: l10n.graphCanvas,
          hint: l10n.drawYourGraphHere,
        ...
        Semantics(
          ...
          child: Padding(
            ...
            child: Text(
              _strokes.isEmpty ? l10n.canvasIsEmpty : l10n.strokesCountPoints(_strokes.length, totalPoints),
      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          ...
          children: [
            ...
            const SizedBox(width: 8),
            _buildStrokeWidthButton(2.0, Icons.horizontal_rule),
            const SizedBox(width: 4),
            _buildStrokeWidthButton(4.0, Icons.remove),
            const SizedBox(width: 4),
            _buildStrokeWidthButton(6.0, Icons.radio_button_unchecked),
          ],
        ),
      ),
    );
  ...
  void _handleUndo() {
    ...
    if (_undoStack.isNotEmpty) {
      ...
      setState(() {
        _strokes..clear()..addAll(restored);
      });
    } else {
      setState(() {
        _strokes.removeLast();
